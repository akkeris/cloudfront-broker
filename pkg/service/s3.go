...
func (s *AwsConfigSpec) AddBucketPolicy(in *InCreateDistributionSpec, out *CloudFrontInstanceSpec) {

	policy, _ := json.Marshal(map[string]interface{}{
		"Version": "2012-10-17",
		"Id":      "PolicyForCloudfrontRead",
		"Statement": []map[string]interface{}{
			{
				...
				"Principal": map[string]interface{}{
					"AWS": []string{
						fmt.Sprintf("arn:aws:iam::cloudfront:user/CloudFront Origin Access Identity %s", out.DistributionID),
					},
				},
				"Action":   "s3:GetObject",
